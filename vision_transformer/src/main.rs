...
use theano_nn::{
    LayerNorm, Linear, MultiheadAttention, CrossEntropyLoss, Module,
};
...
impl TransformerBlock {
    fn new(embed_dim: usize, num_heads: usize, mlp_dim: usize) -> Self {
        Self {
...
// Synthetic data
// ---------------------------------------------------------------------------
fn random_images(batch_size: usize, channels: usize, h: usize, w: usize) -> Tensor {
